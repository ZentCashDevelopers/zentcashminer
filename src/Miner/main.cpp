...
{
    std::cout << InformationMsg("* ") << WhiteMsg("ABOUT", 25) << InformationMsg("zentcashminer " + Constants::VERSION) << std::endl
...
void start(int argc, char **argv)
{
    ...
    {
        std::cout << WarningMsg("Dev fee disabled :( Consider making a one off donation to Ze3iyuhaF8S3FxWgX3nqXodakwxqNzzgXgz4xGezWHPfRt3CsFDeV7EccVykYByuVeTnxTbwUh4CeBM21ftZKMn82QHzRSDe9") << std::endl;
    ...
    else
    {
        ...
        while (true)
        {
            ...
            std::cout << InformationMsg("=== Started mining to the development pool - Thank you for supporting zentcashminer! ===") << std::endl;
            ...
            std::cout << InformationMsg("=== Regular mining resumed. Thank you for supporting zentcashminer! ===") << std::endl;
